...
export default {
  ...
  functional: true,
  render(h) {
    return <div class="rt-skeleton-banner">
                ...
                >
                  ...
                  >
                    <div class="md-flex-fill">
                      <div class="rt-skeleton-banner-header rt-skeleton-banner__wave"></div>
                      <div class="rt-skeleton-banner-label"></div>
                      <div
                    ...
                    <div class="rt-skeleton-banner-paginator">
                    </div>
                  </div>
                </div>
              </rt-col>
