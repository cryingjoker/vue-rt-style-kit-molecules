            ...
            imageStyle() {
                ...
                switch (this.deviceType) {
                    ...
                    case 'tablet':
                        ...
                        if (this.tabletImageMaxHeight) {
                            styles.maxHeight = this.tabletImageMaxHeight;
                        }
                        break
                }
                ...
                if (!this.switchOffTimer) {
                    ...
                    if (RtBanners && !this.isStopped && RtBanners.activeIndex >= 0) {
                        ...
                        RtBanners.timer = setTimeout(() => {
                            if (!this.autoNextOnlyOnDesktop || this.deviceType === 'desktop') {
            ...
            const paginatorItem = () => {
                return this.RtBanners.items.map((option, index) => {
                    ...
                    return <rt-banner-paginator-item
                        ...
                        sleep-time={this.deviceType === 'mobile' ? null : sleepTime}
                        is-pause={this.deviceType === 'mobile' ? false : this.isPause}
                        index={index}
                    />;
                });
            };
