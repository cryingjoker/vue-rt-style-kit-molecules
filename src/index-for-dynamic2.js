...
export default { // Сортировака по принадлежности, как в pages
  ...
  ...load('RtSlideContentDottedContent', 'SlideContentDottedContent/SlideContentDottedContent.vue'),
  ...load('RtSlideContentDottedHeader', 'SlideContentDottedHeader/SlideContentDottedHeader.vue'),
  ...
  ...load('RtBannerItemV2', 'BannerV2/BannerItemV2.vue'),
